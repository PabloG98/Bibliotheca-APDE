...
$buscarTitulo = filter_input(INPUT_GET, 'buscarTitulo');
$buscarAutor = filter_input(INPUT_GET, 'buscarAutor');
$biblioteca = filter_input(INPUT_GET, 'biblioteca');
$select = filter_input(INPUT_GET, 'select');
$orden = filter_input(INPUT_GET, 'orden');
if ($buscarTitulo === '' && $buscarAutor === '' && $biblioteca === '' && $select === '' && $orden === '') {
